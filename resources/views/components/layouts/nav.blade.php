            ...
            <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                ...
                <div class="mx-auto">
                    <div class="flex space-x-4">
                        ...
                        <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                        <a href="{{ route("about") }}"
                            class="px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white {{ request()->routeIs('aboute') ? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                            About
                        </a>
                        <!-- Active: 'text-sky-600 dark:text-white', Inactive 'text-slate-400' -->
                        ...
                        <div class="flex space-x-4">
                            ...
                            @auth
                                <form action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <button class="text-slate-400 text-sm font-medium rounded-md  hover:text-sky-600 dark:hover:text-white">Logout</button>
                                </form>
                            @endauth
                        </div>
                    </div>
